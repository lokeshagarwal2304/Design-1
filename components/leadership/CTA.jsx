    ...
    <section className="relative z-30 w-full bg-slate-50 py-12 md:py-16 px-6 md:px-[80px] font-['Manrope']">
      <div className="max-w-[1400px] mx-auto">
        <motion.div
          ...
          className="relative rounded-[24px] overflow-hidden p-8 md:p-12 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-8 border border-slate-800 group min-h-[200px]"
        >
          {/* Background Image Fill */}
          <div className="absolute inset-0 z-0">
            <Image
              src="/Leadership/cta-bg.png"
              alt="Mutyam Steel Leadership CTA Background"
              fill
              priority
              className="object-cover object-center group-hover:scale-105 transition-transform duration-700"
            />
            {/* Dark Overlay gradient for maximum readability */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#081B3A]/90 via-[#081B3A]/80 to-black/85" />
          </div>
          ...
          <div className="relative z-10 space-y-2 max-w-2xl text-center lg:text-left text-white">
            ...
            <p className="text-slate-200 text-sm md:text-base font-medium opacity-95">
              Partner with Mutyam Steel for trusted quality, reliable support and sustainable growth.
            </p>
          </div>
